...
public class FileChooser extends javax.swing.JFrame {
    ...
    JobDescriptionGUI jdGUI = new JobDescriptionGUI();
    String[] fileArray;
    static int count;
    int cvCount;
    String[] requirements;
    ...
    private void Add_CVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add_CVActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            fileArray[cvCount] = file.getAbsolutePath();
            //increase count
            cvCount++;
            if (cvCount == 10) {
    ...
    private void ResultsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ResultsActionPerformed
        ...
        requirements = jdGUI.read();
        count = jdGUI.getCount();
        ...
        for (int i = 0; i < cvCount; i++) {
            ...
            Converter.start(fileArray[i], requirements, count);
        }
    ...
    public static javax.swing.JTextArea infoCv;
